...
| [SPEC-013-storefront-config](SPEC-013-storefront-config.md) | Backend plugin `JvStorefront`: entities, Admin, `GET /store-api/storefront-config`; контракт — platform SPEC-011 |
