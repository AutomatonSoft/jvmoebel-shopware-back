...
final class StorefrontShippingBadgeDefinition extends EntityDefinition
{
    final public const ENTITY_NAME = 'jv_storefront_shipping_badge';
    ...
    {
        return StorefrontShippingBadgeCollection::class;
    }
