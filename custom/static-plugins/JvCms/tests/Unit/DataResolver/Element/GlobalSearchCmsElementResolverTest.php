...
final class GlobalSearchCmsElementResolverTest extends TestCase
{
    ...
    public static function clampProvider(): iterable
    {
        ...
        yield 'min chars default on 99x' => ['suggestMinChars', 99, 3];
        yield 'min chars accepts 0' => ['suggestMinChars', 0, 0];
        yield 'min chars accepts 10' => ['suggestMinChars', 10, 10];
        yield 'suggest limit clamps 999 to max' => ['suggestLimit', 999, 10];
        yield 'suggest limit default on 999' => ['suggestLimit', 0, 10];
        yield 'history default on 99' => ['historyMaxItems', true, 8];
        yield 'history clamps 99 to max' => ['historyMaxItems', 99, 8];
