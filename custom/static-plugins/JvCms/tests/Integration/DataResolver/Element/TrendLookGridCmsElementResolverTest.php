...
final class TrendLookGridCmsElementResolverTest extends TestCase
{
    ...
    public function testResolverIsRegisteredAndUsedByCmsPipeline(): void
    {
        ...
        $resolver = $container->get(TrendLookGridCmsElementResolver::class);
        self::assertInstanceOf(TrendLookGridCmsElementResolver::class, $resolver);
        ...
        self::assertSame('jv-trend-look-grid', $resolvedSlot->getType());
    ...
    public function testStoreApiEncoderExposesSerializedEmptyContract(): void
    {
        ...
        self::assertSame('cms_jv_trend_look_grid', $payload['apiAlias']);
    ...
    public function testStructEncoderSerializesNonEmptyHappyPath(): void
    {
        ...
        $struct = new TrendLookGridStruct(
            ...
            cards: [
                new TrendLookGridCardStruct(
                    ...
                    url: '/trends/warm',
                    image: new TrendLookGridCardMediaStruct('https://cdn.example.com/warm.webp', 'Warm'),
                ),
            ],
        );
        ...
        self::assertSame('cms_jv_trend_look_grid', $payload['apiAlias']);
        self::assertSame('This season', $payload['eyebrow']);
        self::assertSame('cms_jv_trend_look_grid_card', $payload['cards'][0]['apiAlias']);
        self::assertSame('/trends/warm', $payload['cards'][0]['url']);
        self::assertSame('cms_jv_trend_look_grid_card_media', $payload['cards'][0]['image']['apiAlias']);
    }
    ...
    private function createSlot(array $values): CmsSlotEntity
    {
        ...
        $slot->setUniqueIdentifier('integration-slot-jv-trend-look-grid');
