...
final readonly class QueueCosmoShopProductRedirectImportSubscriber implements EventSubscriberInterface
{
    ...
    public function queue(EntityWrittenEvent $event): void
    {
        foreach ($event->getWriteResults() as $result) {
            ...
            $this->messageBus->dispatch(new CosmoShopProductRedirectImportMessage($log->getId()));
        }
    }
}
