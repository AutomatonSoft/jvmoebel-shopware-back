/**
 * Related look cards config for CMS element `jv-related-look-cards`.
 */
import template from './sw-cms-el-config-jv-related-look-cards.html.twig';
import './sw-cms-el-config-jv-related-look-cards.scss';
...
export default {
    ...
    methods: {
        ...
        cardUploadTag(index) {
            return `cms-element-jv-related-look-cards-card-${this.element.id}-${index}`;
        },
