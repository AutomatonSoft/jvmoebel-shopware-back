...
| [SPEC-005-cms-side-navigation](SPEC-005-cms-side-navigation.md) | Backend CMS element/block `jv-side-navigation` (плагин `JvCms`); контракт Store API — platform SPEC-003 |
