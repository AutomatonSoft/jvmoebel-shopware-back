import template from './sw-cms-el-config-jv-author-footer.html.twig';
import './sw-cms-el-config-jv-author-footer.scss';
...
export default {
    ...
    computed: {
        ...
        imageUploadTag() {
            return `cms-element-jv-author-footer-image-${this.element.id}`;
        },
