...
final readonly class ProductTargetUrlResolver
{
    public function __construct(private Connection $connection)
    {
    }

    public function resolve(string $productId, string $salesChannelId, ?string $sourceUrl = null): ?string
    {
