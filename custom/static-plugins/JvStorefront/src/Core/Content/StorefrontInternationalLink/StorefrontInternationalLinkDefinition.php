...
final class StorefrontInternationalLinkDefinition extends EntityDefinition
{
    final public const ENTITY_NAME = 'jv_storefront_international_link';
    ...
    {
        return StorefrontInternationalLinkCollection::class;
    }
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('target_sales_channel_id', 'targetSalesChannelId', SalesChannelDefinition::class))->addFlags(new ApiAware(AdminApiSource::class), new Required()),
            ...
            (new ManyToOneAssociationField('targetSalesChannel', 'target_sales_channel_id', SalesChannelDefinition::class, 'id', false))->addFlags(new ApiAware(AdminApiSource::class)),
