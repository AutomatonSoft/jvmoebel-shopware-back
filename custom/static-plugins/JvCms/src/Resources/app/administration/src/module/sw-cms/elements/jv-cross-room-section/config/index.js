import template from './sw-cms-el-config-jv-cross-room-section.html.twig';
import './sw-cms-el-config-jv-cross-room-section.scss';
...
export default {
    ...
    created() {
        this.initElementConfig('jv-cross-room-section');
        this.ensureRooms();
    },
    ...
    methods: {
        ...
        roomUploadTag(index) {
            return `cms-element-jv-cross-room-section-room-${this.element.id}-${index}`;
        },
