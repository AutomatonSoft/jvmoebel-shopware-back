...
final readonly class CategoryTargetUrlResolver
{
    public function __construct(private Connection $connection)
    {
    }

    public function resolve(string $categoryId, string $salesChannelId, ?string $sourceUrl = null): ?string
    {
